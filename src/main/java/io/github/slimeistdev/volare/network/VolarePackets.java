...
public class VolarePackets {
	public static final PacketSet PACKETS = PacketSet.builder(Volare.ID, 2)
		.c2s(UpdateGliderC2SPacket.class, UpdateGliderC2SPacket.PACKET_CODEC)
		.c2s(ConfigChangeC2SPacket.class, ConfigChangeC2SPacket.PACKET_CODEC)

		.s2c(SetGliderPhysicsS2CPacket.class, SetGliderPhysicsS2CPacket.PACKET_CODEC)
		.s2c(SetConfigS2CPacket.class, SetConfigS2CPacket.PACKET_CODEC)
